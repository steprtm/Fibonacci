        ...
        showFibonacciButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (maxFibonacciValue == 0 || nextFibonacci <= maxFibonacciValue) {
                    ...
                    Toast.makeText(MainActivity.this, "Reached Max Fibonacci Value", Toast.LENGTH_SHORT).show();
                }
            }
        });
            ...
            public void onClick(DialogInterface dialog, int which) {
                try {
                    ...
                    if (newMax >= 0) {
                        ...
                        Toast.makeText(MainActivity.this, "Enter a valid non-negative number", Toast.LENGTH_SHORT).show();
                    }
